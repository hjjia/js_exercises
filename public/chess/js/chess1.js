 ...
 */
    ...
    logo.onload = function () {
        ...
        drawChessMan(7,7)
        drawChessMan(AI.getFirstPoint(7,7).x,AI.getFirstPoint(7,7).y)
    }
...
chess.onclick = function (e) {
        ...
        var type = me ? 1 : 2;
        var nextChess = AI.nextStep(type)
        drawChessMan(nextChess.x,nextChess.y)
    ...
    var drawChessMan = function (x, y) {
        ...
        if(chessBoardArr[x][y] == 0){
            ...
            console.log("x " + x +" y "+y+" type "+chessBoardArr[x][y])
